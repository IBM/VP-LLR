...
def DataPrepare(dataset_name, dataset_dir, target_size, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225), download=True, batch_size=64, random_state=1, clip_transform=None, CIFAR10_C_mode="gaussian_noise", detect=False, combine_cls=10):
    ...
    if dataset_name == "CIFAR10":
        ...
        trainset = COOPLMDBDataset(root=dataset_dir+"_t", split="train", transform = transform)
        testset = COOPLMDBDataset(root=dataset_dir+"_t", split="test", transform = transform)
        class_names = refine_classnames(testset.classes)
        ...
        os.chdir('/home/joytsao/Reprogramming/AutoVP') 
