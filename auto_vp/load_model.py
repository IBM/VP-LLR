...
def Load_Reprogramming_Model(dataset, device, file_path=None, mapping_method="frequency_based_mapping", set_train_resize=True, pretrained_model="resnet18", mapping=None, scale=1.0, num_map=1, weightinit=True, detect=False, combine_cls=10):
    ##### Model Setting #####
    channel = 3
